...
```javascript
promoteDataTypes = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-promote-dtypes@v0.1.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/ndarray-base-promote-dtypes/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/ndarray-base-promote-dtypes/actions/workflows/test.yml?query=branch:v0.1.1
